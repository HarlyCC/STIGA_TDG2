...
export default function DoctorProfile() {
  ...
  const handleSubmit = async (e) => {
    ...
    setSuccess(false)
    try {
      await client.put('/auth/profile', { telefono: form.telefono.trim() || undefined })
      setSuccess(true)
    } catch (err) {
      ...
      <main style={{ marginLeft: '240px', flex: 1, padding: '2.5rem 2rem', maxWidth: '860px', overflowY: 'auto', height: '100vh' }}>
        <div style={{
          ...
          <div style={{ marginBottom: '2rem' }}>
            ...
            <p style={{ margin: 0, color: '#6b7280', fontSize: '0.9rem' }}>Información de tu cuenta médica</p>
          </div>
              ...
              <div style={{
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.2rem' }}>
                  ...
                  <div>
                    ...
                    <input className="field-input" value={form.cedula} disabled placeholder="—" />
                    <p style={{ margin: '0.3rem 0 0', fontSize: '0.75rem', color: '#9ca3af' }}>El documento no se puede modificar.</p>
                  </div>
          ...
          <form onSubmit={handlePasswordChange} style={{ marginTop: '2rem' }}>
            <div style={{
              ...
              <h3 style={{ margin: '0 0 0.5rem', fontSize: '0.95rem', fontWeight: '700', color: '#374151' }}>
                Cambiar contraseña
              </h3>
              <p style={{ margin: '0 0 1.5rem', fontSize: '0.8rem', color: '#9ca3af' }}>
                Recibiste una contraseña temporal por correo al momento de aprobarse tu cuenta. Te recomendamos cambiarla ahora.
              </p>
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.2rem' }}>
                <div style={{ gridColumn: '1 / -1' }}>
